...
// var url = "mongodb://george.stamati:George01@ds247077.mlab.com:47077/solarsystem_db";
//
// MongoClient.connect(url, function(err, database) {
//     if (err) throw err;
//     console.log("Database created!");
//
//     var db = database.db('solarsystem_db');
//     var collections = db.collection('planets');
//
//     collections.find({}).toArray(function (err, res) {
//         if (err) throw err;
//         database.close();
//     });
//
        ...
        "contents": {
            ...
            "description": {
                ...
                "content": [
                    ...
                    "Saturn has 150 moons and smaller moonlets. All are frozen worlds. The largest moons are Titan and Rhea. Enceladus appears to have an ocean below its frozen surface. Titan is a moon with complex and dense nitrogen-rich atmosphere.",
                ]
            }
        }
    },
