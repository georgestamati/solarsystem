...
router.get('/', checkForMobile, function (req, res) {
	res.render('../../views/welcome', {
		'title': rows.title
	});
});
router.get('/mobile', checkForMobile, function (req, res) {
...
router.get('/galaxy', checkForMobile, function(req, res) {
	res.render('../../views/index', {
		'title': rows.title,
		'items': records
	});
});
router.get('/mobile/galaxy', checkForMobile, function (req, res) {
...
function checkForMobile(type, req, res, next) {
